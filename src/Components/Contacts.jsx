                    ...
                    <div className='mt-6 '>
                        ...
                        <div className="flex items-center gap-2">
                            <a target="_blank" title="Github" href="https://github.com/Jasmeet5108">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512" height="33px" id="Layer_1" version="1.1" viewBox="0 0 512 512" xml:space="preserve"><g><path clip-rule="evenodd" d="M296.133,354.174c49.885-5.891,102.942-24.029,102.942-110.192   c0-24.49-8.624-44.448-22.67-59.869c2.266-5.89,9.515-28.114-2.734-58.947c0,0-18.139-5.898-60.759,22.669   c-18.139-4.983-38.09-8.163-56.682-8.163c-19.053,0-39.011,3.18-56.697,8.163c-43.082-28.567-61.22-22.669-61.22-22.669   c-12.241,30.833-4.983,53.057-2.718,58.947c-14.061,15.42-22.677,35.379-22.677,59.869c0,86.163,53.057,104.301,102.942,110.192   c-6.344,5.452-12.241,15.873-14.507,30.387c-12.702,5.438-45.808,15.873-65.758-18.592c0,0-11.795-21.31-34.012-22.669   c0,0-22.224-0.453-1.813,13.592c0,0,14.96,6.812,24.943,32.653c0,0,13.6,43.089,76.179,29.48v38.543   c0,5.906-4.53,12.702-15.865,10.89C96.139,438.977,32.2,354.626,32.2,255.77c0-123.807,100.216-224.022,224.03-224.022   c123.347,0,224.023,100.216,223.57,224.022c0,98.856-63.946,182.754-152.828,212.688c-11.342,2.266-15.873-4.53-15.873-10.89   V395.45C311.1,374.577,304.288,360.985,296.133,354.174L296.133,354.174z M512,256.23C512,114.73,397.263,0,256.23,0   C114.73,0,0,114.73,0,256.23C0,397.263,114.73,512,256.23,512C397.263,512,512,397.263,512,256.23L512,256.23z" fill="#8992a3" fill-rule="evenodd" /></g></svg>
                            </a>
                            <a target="_blank" title="Linkedin" href="https://www.linkedin.com/in/jasmeetsingh752">
                                <svg xmlns="http://www.w3.org/2000/svg" height="33px" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#8992a3" version="1.1" id="Layer_1" viewBox="-143 145 512 512" xml:space="preserve">
                                    <g>
                            ...
                            <a target="_blank" title="Twitter" href="https://twitter.com/JasmeetSingh752">
                                <svg xmlns="http://www.w3.org/2000/svg" height="34px" class="svg" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z" fill="#8992a3" /></svg>
                            </a>
                        </div>
                    </div>
                    <div className='mt-6 '>
