        ...
        <>
            ...
            <section id='skills' className='max-w-screen-xl mx-auto'>
                <div className="skills flex flex-col lg:flex-row lg:gap-20 lg:items-baseline justify-center items-center mt-8 px-4">
                    <div className="box1 py-1 flex flex-col justify-center ph:w-[300px] ph:h-24 w-[330px] sm:w-[400px] md:w-[450px] md:h-[140px] b-pad:w-[360px] sm:h-[120px] h-28 b-pad:h-32 lg:w-[431px] border-2 border-gray-600 text-center">
                    ...
                    <div className="box2 py-1 flex flex-col justify-center ph:w-[300px] ph:h-24 w-[330px] sm:w-[400px] b-pad:w-[360px] h-28 b-pad:h-32 lg:w-[431px] md:w-[450px] md:h-[140px] lg:h-[140px] sm:h-[120px] mt-10 lg:mt-0 border-2 border-gray-600 text-center">
