...
const Hero = () => {
    ...
    return (
        <>
            <section id="home" className={`max-w-screen-xl ${theme === lightTheme ? "text-black" : "text-[#a6adbb]"} mx-auto animate-fade-up mt-[-120px] sm:mt-[60px] flex flex-col md:flex-row md:justify-between md:items-center md:px-4 lg:px-1 md:mt-7 w-full`}>
